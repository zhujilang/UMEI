        ...
        >
          ...
          <Card style={{ width: 400 }}>
            ...
            <div className={'card-title'}>
              <div>标题：</div>
              <div ><Input  size="small" placeholder="请输入"/></div>
            </div>
            <div>
              <div>插入常规图片</div>
              <div><img src={require('../layouts/top/brand.png')} className={'img'} />
              <img src={require('../layouts/top/brand.png')} className={'img'}</div>
            </div>
            <div></div>
            <div></div>
