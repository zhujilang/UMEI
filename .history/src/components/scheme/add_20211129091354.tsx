    ...
    <div >
      <div className={'add'}>
              ...
              <div>
                <div className={'inputbox'}>
                  <div className={'putbox'}>
                    <Form.Item name="styleName"><Input size="small" /></Form.Item>
                  </div>
        ...
        >
          ...
          <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} closable={false} width={{200}}>
            <div>
              <div className={'mo'}>
                        ...
                        <div >
                          <div>
                            ...
                            <div className={'tab-type'}><Form.Item name="typeName">
                              <Input size="small" placeholder={item.typeName} />
                            </Form.Item></div>
                          </div>
                          <div className={'moda'}>
                            <div className={'moda'}>单品风格</div>
                                ...
                                return (
                                  <div className={'mid'}>
                                    <div>
                                      <div className={'inputbox'}>
                                        <div className={'putbox'}>
                                          <Input size="small" placeholder={item.styleName} />
                                        </div>
