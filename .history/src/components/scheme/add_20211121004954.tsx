      ...
      <div className={'add'}>
        ...
        <div className={'formtable'}>
          <Card style={{ width: 400 }}>
            <Form name="addtype" onFinish={addty} form={form}>
              <div className={'card'} onClick={cancel}><CloseOutlined /></div>
              <div>
                <div>单品类型</div>
                <div className={'formtable-type'}><Form.Item name="categoryName">
          ...
          <Modal visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} closable={false}>
            <div>
              <div className={'mo'}>
                ...
                <div><Button type="link" onClick={addty}>
                  +添加类型
                </Button></div>
              </div>
              <div>
                <Form>
                {types && types.length > 1 ? <div>{
              arrs.map((item: any, index: number) => {
                return (
                  <div >
                    <div className={'card'} onClick={() => {
                ...
                <div className={'mod'}>
                    <div >单品类型</div>
                    <div className={'mod-solo'}><Form.Item><Input size="small" /></Form.Item></div>
                  </div>
                  <div className={'moda'}>
                    <div className={'moda'}>单品风格</div>
                    <div> <Button type="link" onClick={addspec}>
