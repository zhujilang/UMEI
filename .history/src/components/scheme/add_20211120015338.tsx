...
import { Form, Button, message, Input, Select, Card, Modal } from 'antd'
      ...
      <div className={'add'}>
        ...
        >
          ...
          <Card style={{ width: 400 }}>
            <Form name="add"onFinish={add}>
              <div className={'card'}><CloseOutlined /></div>
              <div className={'card-title'}>
                <div>标题：</div>
                <div ><Form.Item name="1">
              ...
              <div className={'button'}><Button icon={<PlusOutlined />} block onClick={add}>
                添加
              </Button></div>
            </Form>
          </Card>
        ...
        <Modal title="插入可切换规格图片" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
