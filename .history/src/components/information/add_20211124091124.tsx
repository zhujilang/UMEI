                ...
                >
                    ...
                    <div className={'add-banner'}>
                        ...
                        <Form.Item name="headImg">
                            <div>
                                <Upload onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Upload><Uploads onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Uploads>
                            </div>
                        </Form.Item>
                    </div>
                </Form>
