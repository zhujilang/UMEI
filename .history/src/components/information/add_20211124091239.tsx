                ...
                >
                    ...
                    <div className={'add-banner'}>
                        ...
                        <Form.Item name="headImg">
                            <div>
                                <Upload onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Upload><Upload onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Upload>
                            </div>
                        </Form.Item>
                    </div>
                </Form>
