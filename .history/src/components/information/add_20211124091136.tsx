...
import { Form, Button, message, Input, Upload, Card, Modal, Divider, Space, Checkbox, Row, Col } from 'antd'
                ...
                >
                    ...
                    <div className={'add-banner'}>
                        ...
                        <Form.Item name="headImg">
                            <div>
                                <Uploads onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Uploads><Uploads onRemove={onRemove} uploadUrl={uploadUrl} fileList={fileList} listType={'picture-card'} maxCount={1}></Uploads>
                            </div>
                        </Form.Item>
                    </div>
                </Form>
