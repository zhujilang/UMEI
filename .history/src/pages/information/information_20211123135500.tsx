...
import Adds from '@/components/information/information';
  ...
  return (
    <div className={'scheme'}>
      <div className={'scheme-all'}>
        ...
        <div>
          {isModalVisible?<Adds isModalVisible={isModalVisible} handleCancel={handleCancel} query={status} pageSize={pageSize} current={pageNum} item={item} modalTitle={modalTitle} ></Adds>:
          <>
          ...
          <Informations edit={edit} onPageChange={onPageChange} status={status} pageSize={pageSize} pageNum={pageNum} ></Informations>
          </> 
        }
        </div>
      </div>
