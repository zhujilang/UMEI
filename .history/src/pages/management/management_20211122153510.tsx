...
import Adds from '@/components/management/add';
    ...
    <div className={'management'}>
      <div className={'management-all'}>
        ...
        <div className={'management-body'}>
           {isModalVisible?<div >
               <Adds isModalVisible={false} handleCancel={function (): void {
                          throw new Error('Function not implemented.');
                      } } modalTitle={''} query={''} pageSize={0} current={0} item={undefined}></Adds>
           </div>:<div>
