  ...
  return (
    <div className={'scheme'}>
      <div className={'scheme-all'}>
        ...
        <div>
          {isModalVisible?<Adds isModalVisible={isModalVisible} handleCancel={handleCancel} query={handleCancel} handleCancel={handleCancel} handleCancel={handleCancel} handleCancel={handleCancel}></Adds>:
          <>
