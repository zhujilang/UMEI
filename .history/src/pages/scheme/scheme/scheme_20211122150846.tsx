  ...
  return (
    <div className={'scheme'}>
      <div className={'scheme-all'}>
        ...
        <div>
          {isModalVisible?<Adds isModalVisible={isModalVisible} handleCancel={handleCancel} query={status} pageSize={pageSize} current={pageNum} item={item} modalTitle={modalTitle} item1={undefined} item2={undefined} value={undefined} ></Adds>:
          <>
