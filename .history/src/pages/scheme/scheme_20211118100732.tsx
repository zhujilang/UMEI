  ...
  return (
    <div className={'scheme'}>
      <div className={'scheme-all'}>
        ...
        <div>
          {isModalVisible?<Adds isModalVisible={isModalVisible} handleCancel={function (): void {
            throw new Error('Function not implemented.');
          } } modalTitle={''} query={''} pageSize={0} current={0} item={undefined} classifyInfo={undefined} ></Adds>:
          <>
