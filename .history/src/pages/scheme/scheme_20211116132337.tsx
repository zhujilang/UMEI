...
const Scheme = () => {
  ...
  // 获取整屋数据
  const getData = (pageNum: number, pSize: number, statusVal: string) => {
    dispatch(
      {
    ...
    return (
        <div className={'scheme'}>
            <div className={'scheme-all'}>
                ...
                <div>
                <Schemes edit={edit} onPageChange={onPageChange} status={status} pageSize={pageSize} pageNum={current}></Schemes>
                </div>
            </div>
