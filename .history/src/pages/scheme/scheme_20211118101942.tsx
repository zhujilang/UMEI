  ...
  return (
    <div className={'scheme'}>
      <div className={'scheme-all'}>
        ...
        <div>
          {isModalVisible?<Adds isModalVisible={isModalVisible} handleCancel={handleCancel} query={status} pageSize={pageSize} current={pageNum} item={item} classifyInfo={classifyInfo}></Adds>:
          <>
